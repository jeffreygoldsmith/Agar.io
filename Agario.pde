...
void draw()
{
  ...
  if (distance(x, circleX[14], y, circleY[14]) <= DIAM / 2)
  {
    ...
    circleY[14] = random(0, 500);
    DIAM += 2;
  }

  font = createFont("Source Sans Pro", 22);
  textFont(font);
  text("Mass is: " + DIAM, 0, 0);
